...
ActiveRecord::Schema.define(version: 20140403061510) do
  ...
  add_index "default_events", ["year"], name: "index_default_events_on_year"
  ...
  add_index "scores", ["schedule_id"], name: "index_scores_on_schedule_id"
  ...
  add_index "sign_ups", ["team_id"], name: "index_sign_ups_on_team_id"
  add_index "sign_ups", ["timeslot_id"], name: "index_sign_ups_on_timeslot_id"
  ...
  add_index "teams", ["tournament_id", "division"], name: "index_teams_on_tournament_id_and_division"
  ...
  create_table "tournaments", force: true do |t|
    ...
    t.text     "hosted_by_markdown",             default: "You can edit this text in _Tournament Settings_ in the [Admin Panel](/user/login)."
    t.text     "homepage_markdown",              default: "You can edit this text in _Tournament Settings_ in the [Admin Panel](/user/login)."
    t.string   "title"
    t.datetime "date"
